            ...
            <form action="{{ route('admin.banners.update', $banner->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row">
                    <div class=" col-md-6">
                        ...
                        <input name="title" class='form-control' value=' {{ $banner->title }}' type='text'
                            placeholder="Enter Banner Title">
                    </div>
                    <div class=" col-md-6">
                        <label class="form-label">Banner Link</label>
                        <input name="link" class='form-control' value=' {{ $banner->link }}' type='url'
                            placeholder="Enter Banner url">
                    </div>
                    <div class="col-md-6">
                        <label class="form-label">Type</label>
                        <select name="type" id="" class="form-control">
                            <option value="1" @if ($banner->type == 1) selected @endif>Main</option>
                            <option value="0" @if ($banner->type == 0) selected @endif>Pop up</option>
                    ...
                    <div class=" col-md-12">
                        ...
                        <textarea name="details" id="summernote" cols="30" rows="10">{{ $banner->details }}</textarea>
                    </div>
