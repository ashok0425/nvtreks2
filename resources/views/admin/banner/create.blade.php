            ...
            <div class="row">
                <div class="col-md-4">
                    ...
                    <select name="type" id="bannerType" class="form-control">
                        <option value="1" {{ old('type') == 1 ? 'selected' : '' }}>Banner/Video</option>
                        <option value="3" {{ old('type') == 3 ? 'selected' : '' }}>Instagram Link</option>
                ...
                <div id="linkField" class="col-md-12 mt-3">
                    ...
                    <textarea name="details" id="embedBody" class="form-control" rows="3" placeholder="Paste your link here">{{ old('details') }}</textarea>
                </div>
