...
<x-errormsg/>
        <form action="{{route('admin.teams.store')}}" method="POST" enctype="multipart/form-data">
            ...
            <div class=" col-md-6">
             ...
             <input name="name"   class='form-control' value=' {{ old('name') }}' type='text' placeholder="Enter  Name">
            </div>

            <div class=" col-md-6">
                <label class="form-label"> Position</label>
             <input name="position"   class='form-control' value=' {{ old('position') }}' type='text' placeholder="Enter  position">
            </div>
            <div class=" col-md-6 my-2">
                <label class="form-label">Content</label>
             <input name="content" class="form-control"   value="{{ old('content') }}">
            </div>
